...
The 'main.R' code is used to call two different scripts; 'raw_parser.R' en 'extract_statistics.R'. These scripts rework the data from last years tournament into a 64-bit string which can be used in the agent.
