...
## Common Strategies (Note: for now the strategies are just copy pasted and text should be still adjusted)

### 1. Always Cooperate
Cooperates on every move 2) 

### 2. Always Defect
Defects on every move

### 3. Tit for Tat
Cooperates on the first move, then simply copies the opponent’s last move.
...
### 15. NaiveProber
Like TitforTat,but occasionally defects.
